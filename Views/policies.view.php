    ...
    <main class="container mx-w-6xl mx-auto pt-4 border rounded-lg px-2 bg-gray-100 ">
        <div class="flex-grow flex flex-col bg-white rounded-lg p-2"> 
            ...
            <div class="px-4 py-2 bg-white shadow-full rounded-lg text-gray-700">
                <div class="col-span-3 bg-white p-2 rounded-xl border border-gray-50 flex flex-col space-y-6">
                                                ...
                                                <td class="text-sm p-3 border-t border-grey-light whitespace-no-wrap text-sm group-hover:visible">
                                                    <div class="md:text-base text-gray-800 flex items-center gap-2">
                                                        <div x-data="{ open: false }">
                                                            <a @click.prevent="open = true" href="viewpolicy?policy_id<?= "$policy->id&uname=$policy->policy_no" ?>">
                                                        ...
                                                        <div x-data="{ open: false }">
                                                            <a @click.prevent="open = true" href="editpolicy?policy_id<?= "$policy->id&uname=$policy->policy_no" ?>">
                                                        ...
                                                        <?php if (isAdmin()) : ?>
                                                            <div x-data="{ open: false }">
                                                                <a @click.prevent="open = true" href="deletepolicy?policy_id<?= "$policy->id&uname=$policy->policy_no" ?>">
