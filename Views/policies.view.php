                                                    ...
                                                    <?php if (!empty($policies)) : ?>
                                                        <?php foreach ($policies as $policy) : ?>
                                                            <tr class="group cursor-pointer hover:bg-gray-50">
                                                                <td class="text-sm p-3 border-t border-grey-light whitespace-no-wrap"><?= $policy->name; ?></td>
                                                                <td class="text-sm p-3 border-t border-grey-light whitespace-no-wrap"><?= $policy->email; ?></td>
                                                                <td class="text-sm p-3 border-t border-grey-light whitespace-no-wrap"><?= $policy->business_no; ?></td>
                                                                <td class="text-sm p-3 border-t border-grey-light whitespace-no-wrap text-center"><?= $policy->created_at; ?></td>
                                                                <td class="text-sm p-3 border-t border-grey-light whitespace-no-wrap text-sm group-hover:visible">
                                                                    <div class="md:text-base text-gray-800 flex items-center gap-2">
                                                                        <div x-data="{ open: false }">
                                                                            <a @click.prevent="open = true" href="viewuser?user_id<?= "$policy->id&uname=$policy->name" ?>">
                                                                                    ...
                                                                                    <div class="border bg-white p-4 my-2 max-w-md rounded-lg">
                                                                                        ...
                                                                                        <div class="border-b px-4 pb-6 my-2">
                                                                                            <div class="text-center sm:text-left sm:flex mb-4">
                                                                                                <img class="h-32 w-32 rounded-full border-4 border-white -mt-16 mr-4" src="https://ui-avatars.com/api/?background=random&name=<?= $policy->name; ?>" alt="">
                                                                                                <div class="py-2">
                                                                                                    <h3 class="font-bold text-2xl mb-4 text-gray-500 "><?= " $policy->name;" ?></h3>
                                                                                                    <div class="space-y-2">
                                                                                                        ...
                                                                                                        <div class="inline-flex text-grey-dark sm:flex items-center space-x-2">
                                                                                                            ...
                                                                                                            <span class="font-medium text-gray-500 "><?= ucfirst($policy->name); ?></span>
                                                                                                        </div>
                                                                                                        <div class="inline-flex text-grey-dark sm:flex items-center space-x-2">
                                                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-500 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                                                                                            </svg>
                                                                                                            <span class="text-blue-700 hover:underline dark:text-blue-500"><?= $policy->email; ?></span>
                                                                                                        </div>
                                                                                                        <div class="inline-flex text-grey-dark sm:flex items-center space-x-2">
                                                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-500 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                                        ...
                                                                        <div x-data="{ open: false }">
                                                                            <a @click.prevent="open = true" href="edituser?user_id<?= "$policy->id&uname=$policy->name" ?>">
                                                                            ...
                                                                            <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center " style="background-color: rgba(0,0,0,.5);" x-show="open">
                                                                                <div class="text-left bg-white h-auto p-4 md:max-w-xl md:p-6 lg:p-8 shadow-xl rounded-lg bg-gray-50  mx-2 md:mx-0" @click.away="open = false">
                                                                                    <h2 class="text-2xl text-green-500">Editing <?= " $policy->name"; ?></h2>
                                                                                    ...
                                                                                    <div class="flex space-x-4">
                                                                                            <div class="mb-6">
                                                                                                ...
                                                                                                <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     " value="<?= " $policy->name"; ?>" required>
                                                                                            </div>
                                                                                            <div class="mb-6">
                                                                                                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">Email</label>
                                                                                                <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     " value="<?= " $policy->email"; ?>" required>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="flex space-x-4">
                                                                                            <div class="mb-6">
                                                                                                <label for="business_no" class="block mb-2 text-sm font-medium text-gray-900 ">Business Number</label>
                                                                                                <input type="business_no" name="business_no" id="business_no" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="<?= " $policy->business_no"; ?>" required>
                                                                                            </div>                                                                                           
                                                                                        </div>
                                                                        ...
                                                                        <?php if (isAdmin()) : ?>
                                                                            <div x-data="{ open: false }">
                                                                                <a @click.prevent="open = true" href="deleteuser?user_id<?= "$policy->id&uname=$policy->name" ?>">
                                                                                        ...
                                                                                        <div class="border bg-white p-4 my-2 max-w-md rounded-lg">
                                                                                            <div class="sm:flex sm:items-start">
                                                                                                ...
                                                                                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                                                                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Delete <?= ucfirst($policy->name); ?></h3>
                                                                                                    <div class="mt-2">
                                                                                                        <p class="text-sm text-gray-500">Are you sure you want to delete this Insurer (<span class="font-medium "><?= ucfirst($policy->name); ?></span>)? All of <span class="font-medium "><?= ucfirst("$policy->name's"); ?></span> data will be permanently removed. This action cannot be undone!</p>
                                                                                                    </div>
                                                                                                </div>
