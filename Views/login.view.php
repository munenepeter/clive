...
<div class="bg-gradient-to-r from-red-50 to-blue-50 min-h-screen  p-4">
	<center>
		<div class="mt-28 w-full max-w-md p-8 space-y-3 rounded-xl bg-white border border-blue-700">
			...
			<form novalidate="" action="" method="post" class="space-y-6 ng-untouched ng-pristine ng-valid">
				<div class="space-y-1 text-sm">
					...
					<input type="email" name="email" id="email" placeholder="Email" class="w-full px-4 py-3 rounded-md border border-blue-700 bg-gradient-to-r from-red-50 to-blue-50 text-blue-900" required>
				</div>
				<div class="space-y-1 text-sm">
