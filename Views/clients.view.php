...
<div class="bg-gray-50 py-2 w-full">
    <main class="container mx-w-6xl mx-auto pt-4 border rounded-lg px-2 bg-gray-100 ">
        <div class="flex-grow flex flex-col bg-white rounded-lg p-2">
            ...
            <div class="my-2 border-b border-orange-200"></div>
            <div class="px-4 bg-white shadow-full rounded-lg text-gray-700">
                <div class="col-span-3 bg-white p-2 rounded-xl border border-gray-100 flex flex-col space-y-4">
                                                                    ...
                                                                    <div class="border bg-white p-4 my-2 max-w-md rounded-lg">
                                                                        ...
                                                                        <div class="border-b px-4 pb-6 my-2">
                                                                            <div class="text-center sm:text-left sm:flex mb-4">
                                                                                <img class="h-32 w-32 rounded-full border-4 border-white -mt-16 mr-4" src="https://ui-avatars.com/api/?background=random&name=<?= $client->full_names; ?>" alt="">
                                                                                <div class="py-2">
                                                                                    <h3 class="font-bold text-2xl mb-4 text-gray-500 "><?= " $client->full_names"; ?></h3>
                                                                                    <div class="space-y-2">
                                                                                        ...
                                                                                        <div class="inline-flex text-grey-dark sm:flex items-center space-x-2">
                                                                                            ...
                                                                                            <span class="font-medium text-gray-500 "><?= ucfirst($client->full_names); ?></span>
                                                                                        </div>
                                                                                        <div class="inline-flex text-grey-dark sm:flex items-center space-x-2">
                                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-500 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                                                                            </svg>
                                                                                            <span class="text-blue-700 hover:underline dark:text-blue-500"><?= $client->email; ?></span>
                                                                                        </div>
                                                                                        <div class="inline-flex text-grey-dark sm:flex items-center space-x-2">
                                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-500 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
