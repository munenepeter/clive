...
<div class="flex-shrink-0 w-64 bg-gray-900">
        <a href="#">
          <div
            class="flex items-center h-16 px-4 bg-gray-900 text-xl text-white font-medium"
          >
            <svg
              class="relative w-8 h-8 fill-current"
              version="1.0"
...
-50 83 -150 250 -222 373 -182 307 -182 307 -399 152z"
            ...
            <div class="ml-2" style="padding-top: 2px;">bobrtc</div>
          </div>
        </a>
        <div>
          <div class="px-2 py-2">
          ...
          <div class="px-6 py-6 text-white">
            <a href="/app/" class="router-link-exact-active router-link-active">
              Phonebook
            </a>
          </div>
          <!---->
