    ...
    <div class="container flex justify-between h-16 mx-auto">
        ...
        <ul class="items-stretch hidden space-x-3 md:flex">
            <?php if (!auth()) : ?>
                ...
                <li class="flex">
                    <a rel="noopener noreferrer" href="#" class="flex items-center px-4 -mb-1 border-b-2 border-transparent hover:text-blue-800 hover:border-blue-800">Blog</a>
                </li>
                <li class="flex">
            ...
            <li class="flex">
                <div class="relative mt-6" x-data="{ isOpen: false}">
                    ...
                    <ul x-show="isOpen" @click.away="isOpen = false" class="absolute font-normal bg-white shadow overflow-hidden bg-indigo-100 rounded w-32 border mt-2 py-1 right-0 z-20">
                        <li>
                            <a href="#" class="flex items-center px-3 py-3 hover:bg-blue-200">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li class="border-b border-gray-400">
                            <a href="#" class="flex items-center px-2 py-2 hover:bg-blue-200">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
