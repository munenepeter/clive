<header class="p-2">
    <div class="container flex justify-between h-16 mx-auto">
        ...
        <ul class="items-stretch hidden space-x-3 md:flex">
            ...
            <li class="flex">
                <a rel="noopener noreferrer" href="#" class="flex items-center px-4 -mb-1 border-b-2 border-transparent">Clients</a>
            </li>
            <li class="flex">
                <a rel="noopener noreferrer" href="#" class="flex items-center px-4 -mb-1 border-b-2 border-transparent">Contact</a>
            </li>
            <li class="flex">
                <a rel="noopener noreferrer" href="/login" class="flex items-center px-4 -mb-1 border-b-2 border-transparent">
