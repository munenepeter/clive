        ...
        <fieldset class="grid grid-cols-4 gap-6 p-6 rounded-md shadow-md ">
            ...
            <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                ...
                <div class="col-span-full sm:col-span-3">
                    ...
                    <input id="role" name="role" type="text" placeholder="admin, guest or user" class="p-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full">
                </div>
                <div class="col-span-full sm:col-span-3">
