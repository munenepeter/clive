...
<head>
    ...
    <!-- MESSAGE SUBJECT -->
    <title>Welcome to Clive <?php echo $uname; ?></title>
...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%; height: 100%; -webkit-font-smoothing: antialiased; text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; line-height: 100%;
	...
	max-width: 560px;" class="wrapper">
			...
			padding-bottom: 20px;">
                            <a target="_blank" style="text-decoration: none;" href="/"><img border="0" vspace="0"
                                    hspace="0" src="../../static/imgs/icons/favicon.svg" width="100" height="30"
                                    alt="Logo" title="Logo"
                                    style="
				color: #000000;
	...
	max-width: 560px;" class="container">
			...
			font-family: sans-serif;" class="subheader">
                    ...
                    <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
			padding-top: 10px;" class="hero"><a target="_blank" style="text-decoration: none;" href="/"><img border="0"
                                    vspace="0" hspace="0"
			...
			font-family: sans-serif;" class="paragraph">
                            Your account at clive was successfully created.
                            <br>In order for you to continue please login with the following credentials <br>
			...
			padding-bottom: 5px;" class="button">
					...
					color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;" href="/login"
			...
			color: #000000;
			font-family: sans-serif;" class="paragraph">
                            Have an&nbsp;issuer? <a href="mailto:admin@clive.com" target="_blank"
                                style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">admin@clive.com</a>
                        </td>
                    </tr>
